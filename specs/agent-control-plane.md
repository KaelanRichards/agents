...
- **Out:** Replacing Claude/Codex, adopting a full external orchestrator, exposing a public HTTP service, broadening personal-action/provider privileges, or auto-approving production mutations.
