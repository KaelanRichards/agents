...
In this environment, use the synced `notion` MCP server. Tool names may appear as
`Notion:notion-*` in Claude plugin examples or as client-native `notion` MCP tool names.
